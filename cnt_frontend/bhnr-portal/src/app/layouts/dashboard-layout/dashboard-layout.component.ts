      ...
      <div class="flex">
        <aside class="hidden w-72 flex-shrink-0 border-r border-slate-200 bg-white p-6 md:block">
          <div class="mb-10 flex items-center gap-3">
            ...
            <p class="text-lg font-semibold text-primary-800">Banca Henar Empresas</p>
          </div>
          ...
          <nav class="space-y-6 text-sm">
            ...
            <div class="space-y-2 text-slate-500">
              <p class="text-xs uppercase tracking-[0.2em]">Próximamente</p>
              <div class="rounded-xl border border-slate-200 px-4 py-3 bg-white">Cuentas &amp; Tarjetas</div>
              <div class="rounded-xl border border-slate-200 px-4 py-3 bg-white">Financiación</div>
              <div class="rounded-xl border border-slate-200 px-4 py-3 bg-white">Documentación</div>
              <div class="rounded-xl border border-slate-200 px-4 py-3 bg-white">Ajustes</div>
            </div>
          </nav>
        </aside>
        ...
        <section class="flex flex-1 flex-col">
          <header class="border-b border-slate-200 bg-white/90 px-6 py-5 backdrop-blur">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <p class="text-sm text-slate-500">Panel Corporativo</p>
                <p class="text-2xl font-semibold text-slate-900">
                  Hola, {{ user()?.name ?? 'Usuario' }} — {{ user()?.company ?? 'BHNR' }}
                </p>
              </div>
